    ...
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <section className="relative border-y border-zinc-200/80 py-20 px-6 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4 md:gap-6">
            {[
              { value: String(testimonials.length), label: "Testimonials", icon: Quote, iconBg: "bg-emerald-100", iconColor: "text-emerald-600", valueColor: "text-emerald-600" },
      ...
      <section className="relative py-28 px-6 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="mx-auto max-w-xl text-lg text-zinc-600 mb-10 leading-relaxed">
